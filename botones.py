...
botones_vision_dos = [
    ...
    ("Descriptores de Región", "vision.descriptores_region", "🧊 Detección de objetos", "panel_objetos", "Descriptores de región"),
    ("Descriptores de Perímetro", "vision.descriptores_perimetro", "🧊 Detección de objetos", "panel_objetos", "Descriptores de perímetro"),
    ("Descriptores","vision.descriptores","🧊 Detección de objetos","panel_objetos","Descriptores de región"),
